/**
 * Editor_emergency_system_glut.cpp
 * Emergency renderer that uses system GLUT for rendering
 * Generates PNG frames of a default scene
 */
...
// Draw a point light
void drawPointLight(float x, float y, float z) {
    glPushMatrix();
    glTranslatef(x, y, z);
...
int main(int argc, char** argv) {
    std::cout << "Starting emergency renderer with system GLUT..." << std::endl;
