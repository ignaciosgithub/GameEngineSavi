/**
 * Editor_emergency.cpp
 * Emergency renderer for GameEngineSavi editor.
 * 
 * This file contains a modified version of the editor that renders each frame
 * to a file instead of directly to the screen. A separate Python script using
 * pygame will display these rendered frames.
 */
...
int WinMain(void* hInstance, void* hPrevInstance, char* lpCmdLine, int nCmdShow) {
    ...
    wc.lpszClassName = "EmergencyRendererClass";
    ...
    HWND hWnd = CreateWindow(
        "EmergencyRendererClass", "Emergency Renderer",
        WS_OVERLAPPEDWINDOW,
...
int main(int argc, char** argv) {
    std::cout << "Starting emergency renderer on Linux..." << std::endl;
    ...
    // Set window title
    XStoreName(display, window, "Emergency Renderer");
