 ...
 * 
 * This file contains a modified version of the editor that renders a cube
 * using the default red shader and saves frames to PNG files.
 */
...
void InitializeEditor() {
    ...
    // Create default objects (including a cube)
...
int WinMain(void* hInstance, void* hPrevInstance, char* lpCmdLine, int nCmdShow) {
    std::cout << "Starting emergency editor red cube renderer on Windows..." << std::endl;
    ...
    wc.lpszClassName = "EmergencyEditorRedCubeClass";
    ...
    HWND hWnd = CreateWindow(
        "EmergencyEditorRedCubeClass", "Emergency Editor Red Cube",
        WS_OVERLAPPEDWINDOW,
    ...
    // Get graphics API
    auto& graphicsFactory = GraphicsAPIFactory::GetInstance();
    auto graphicsAPI = graphicsFactory.GetGraphicsAPI();
    ...
    while (running && frameCount < 10) { // Limit to 10 frames for testing
        ...
        if (editor) {
            ...
            // Use default red shader for rendering
            graphicsAPI->UseDefaultRedShader();
    ...
    std::cout << "Emergency editor red cube rendering complete. " << frameCount << " frames rendered." << std::endl;
...
int main(int argc, char** argv) {
    std::cout << "Starting emergency editor red cube renderer on Linux..." << std::endl;
    ...
    // Set window title
    XStoreName(display, window, "Emergency Editor Red Cube");
