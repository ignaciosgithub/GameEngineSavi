...
EXISTING_CPP_FILES=""
for file in Editor/EditorMain.cpp Scene.cpp GameObject.cpp Vector3.cpp Matrix4x4.cpp Camera.cpp CameraManager.cpp Model.cpp Texture.cpp PointLight.cpp Debugger.cpp FrameCapture.cpp FrameCapture_png.cpp; do
    if [ -f "$file" ]; then
